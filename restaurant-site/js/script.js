...
function buildCategoriesViewHtml(categoriesJson,
                                 categoriesTitleHtml,
                                 categoryHtml) {
	
  	categories = JSON.parse(categoriesJson.response);
...
function buildMenuItemsViewHtml(categoryMenuItemsJson,
                                menuItemsTitleHtml,
                                menuItemHtml) {
  
    categoryMenuItems = JSON.parse(categoryMenuItemsJson.response);

    menuItemsTitleHtml = menuItemsTitleHtml.response;

    menuItemHtml = menuItemHtml.response;
